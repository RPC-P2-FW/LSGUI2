...
void histogram::setupPlot_CB(void){
    ...
    //-----------------------------------------------------------------
    subRectTop->axis(QCPAxis::atBottom)->setTickLabelRotation(90);
    ...
    subRectTop->axis(QCPAxis::atTop)->setLabel(" LB1 MultiChannel Histogram - Adjustable Window");
    //-----------------------------------------------------------------
    // prepare y axis:
    subRectTop->axis(QCPAxis::atLeft)->rescale(true);
    ...
    //-----------------------------------------------------------------
    subRectTop->axis(QCPAxis::atRight)->rescale(true);
    ...
    subRectBotton->axis(QCPAxis::atBottom)->setTickLabelRotation(90);
    ...
    subRectBotton->axis(QCPAxis::atTop)->setLabel(" LB1 MultiChannel Histogram - Full Window");
    ...
    //-----------------------------------------------------------------
    // prepare y axis:
    subRectBotton->axis(QCPAxis::atLeft)->rescale(true);
    ...
    //-----------------------------------------------------------------
    subRectBotton->axis(QCPAxis::atRight)->rescale(true);
...
void histogram::setupPlot_LB(unsigned int LBM){
...
//=================================================
void histogram::setupPlot_LB1(void){
    ...
    */
    ...
    subRectTop->setMarginGroup(QCP::msBottom |QCP::msTop | QCP::msRight | QCP::msLeft, marginGroup);
    subRectBotton->setMarginGroup(QCP::msBottom |QCP::msTop| QCP::msRight | QCP::msLeft, marginGroup);
    wideAxisRect->setMarginGroup(QCP::msTop | QCP::msBottom | QCP::msRight | QCP::msLeft, marginGroup);
    ...
    subRectTop->axis(QCPAxis::atBottom)->setTicker(textTicker);
    subRectTop->axis(QCPAxis::atBottom)->setTickLabelRotation(90);
    subRectTop->axis(QCPAxis::atBottom)->setLabel("RPC Channels 1-96");
    subRectTop->axis(QCPAxis::atBottom)->setSubTicks(false);
    subRectTop->axis(QCPAxis::atBottom)->setTickLength(0, 4);
    ...
    //subRectTop->axis(QCPAxis::atTop)->setTicker(textTicker);
    subRectTop->axis(QCPAxis::atTop)->setRange(0, 96);
    subRectTop->axis(QCPAxis::atTop)->setTickLength(0, 4);
    subRectTop->axis(QCPAxis::atTop)->setSubTicks(true);
    subRectTop->axis(QCPAxis::atTop)->setBasePen(QPen(Qt::white));
    ...
    //subRectTop->axis(QCPAxis::atRight)->rescale(true);
    subRectTop->axis(QCPAxis::atRight)->setRange(0, 0);
    subRectTop->axis(QCPAxis::atRight)->setPadding(1); // a bit more space to the left border
    subRectTop->axis(QCPAxis::atRight)->setBasePen(QPen(Qt::white));
    subRectTop->axis(QCPAxis::atRight)->setTickPen(QPen(Qt::white));
    subRectTop->axis(QCPAxis::atRight)->setSubTickPen(QPen(Qt::white));
...
//=================================================
void histogram::setupPlot_LB2(void){
...
//=================================================
void histogram::setupPlot_LB3(void){
...
//=================================================
void histogram::setupPlot_LB4(void){
...
//=================================================
void histogram::setupPlot_LB5(void){
...
//=================================================
void histogram::setupPlot_LB6(void){
...
//=================================================
void histogram::setupPlot_LB7(void){
...
//=================================================
void histogram::setupPlot_LB8(void){
...
//=================================================
void histogram::setupPlot_LB9(void){
