...
Mythread_BE_DataProcess::Mythread_BE_DataProcess(QObject *parent) : QThread(parent)
{
...
//
//==========================================================================
Mythread_BE_DataProcess::~Mythread_BE_DataProcess(){
...
void Mythread_BE_DataProcess::BE_dataProcess_transaction(void){

    const QMutexLocker locker(&be_dpc_mutex);
...
void Mythread_BE_DataProcess::run(){
    ...
    for (findex = 0 ; findex<=117 ; findex=findex+3){
        ...
        //qDebug() << "3- packet_cnt : " << QString("%1").arg(packet_cnt, 0, 10);
        ...
        if (Field1 == 15){
            ...
            */
            ...
            if ((hit1_stripNum[frameCnt]<=96)/*&&(hit1_stripNum[frameCnt][packet_cnt2]!=127)*/){

                RPCHitTimingPrf[ArrayPnt1] =  RPCHitTimingPrf[ArrayPnt1] +  1 ;
            }

            if ((hit2_stripNum[frameCnt]<=96)/*&&(hit2_stripNum[frameCnt][packet_cnt2]!=127)*/){

                RPCHitTimingPrf[ArrayPnt1] =  RPCHitTimingPrf[ArrayPnt1] +  1 ;
            }

            if ((hit3_stripNum[frameCnt]<=96)/*&&(hit3_stripNum[frameCnt][packet_cnt2]!=127)*/){
                RPCHitTimingPrf[ArrayPnt1] =  RPCHitTimingPrf[ArrayPnt1] +  1 ;
            }

            if ((hit4_stripNum[frameCnt]<=96)/*&&(hit4_stripNum[frameCnt][packet_cnt2]!=127)*/){
                RPCHitTimingPrf[ArrayPnt1] =  RPCHitTimingPrf[ArrayPnt1] +  1 ;
            }

            if ((hit5_stripNum[frameCnt]<=96)/*&&(hit5_stripNum[frameCnt][packet_cnt2]!=127)*/){
                RPCHitTimingPrf[ArrayPnt1] =  RPCHitTimingPrf[ArrayPnt1] +  1 ;
            }

            if ((hit6_stripNum[frameCnt]<=96)/*&&(hit6_stripNum[frameCnt][packet_cnt2]!=127)*/){
                RPCHitTimingPrf[ArrayPnt1] =  RPCHitTimingPrf[ArrayPnt1] +  1 ;
            }
