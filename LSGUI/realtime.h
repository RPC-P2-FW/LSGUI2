...
public:
    explicit realTime(QWidget *parent);
    ~realTime();
    ...
    unsigned int y0CB_Strip [100][100];

    unsigned int y0LB1_Strip [100][100];
    unsigned int y0LB2_Strip [100][100];
    unsigned int y0LB3_Strip [100][100];
    unsigned int y0LB4_Strip [100][100];
    unsigned int y0LB5_Strip [100][100];
    unsigned int y0LB6_Strip [100][100];
    unsigned int y0LB7_Strip [100][100];
    unsigned int y0LB8_Strip [100][100];
    unsigned int y0LB9_Strip [100][100];
