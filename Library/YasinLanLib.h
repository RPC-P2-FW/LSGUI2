...
YASINLANLIB_API bool YE_TCP_WriteMem(_In_ USHORT address, _In_bytecount_(length) void* buffer, _In_ USHORT length);
...
YASINLANLIB_API bool YE_TCP_SendMem(_In_count_(length) const char buffer[], _In_ size_t length);
