...
QT_MOC_LITERAL(3, 19, 4), // "UINT"
QT_MOC_LITERAL(4, 24, 12) // "rec_complete"

    },
    "MyThread\0response\0\0UINT\0rec_complete"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->response((*reinterpret_cast< const UINT(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyThread::*)(const UINT );
...
// SIGNAL 0
void MyThread::response(const UINT _t1)
{
